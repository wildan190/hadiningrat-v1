<div class="fixed top-0 left-0 right-0 z-50 px-4 sm:px-0">
    <header 
        x-data="{ open: false, servicesOpen: false, mobileServicesOpen: false }" 
    ...
    >
        <nav class="px-4 sm:px-6 lg:px-8 flex justify-between items-center py-2 sm:py-3">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2" aria-label="Hadiwijaya Bore Pile - Home">
                ...
                <span class="text-xl sm:text-2xl font-bold font-title">
                    <span class="text-[rgb(30,40,70)]">Hadiwijaya</span>
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <div class="relative" @mouseenter="servicesOpen = true" @mouseleave="servicesOpen = false">
                    ...
                    >
                        <div class="py-1">
                            <a href="{{ route('bore-pile-hydraulic')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-[rgb(213,104,62)] transition-colors duration-200">Bore Pile Hydraulic</a>
                            <a href="{{ route('bore-pile-manual') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-[rgb(213,104,62)] transition-colors duration-200">Bore Pile Manual</a>
                            <a href="{{ route('bore-pile-mini-crane') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-[rgb(213,104,62)] transition-colors duration-200">Bore Pile Mini Crane</a>
                            <a href="{{ route('products.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-[rgb(213,104,62)] transition-colors duration-200">Area Layanan</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Mobile Menu Button -->
            <div class="md:hidden">
                <button @click="open = !open" class="text-[rgb(30,40,70)] focus:outline-none">
        ...
        <div x-show="open" x-cloak class="md:hidden bg-white border-t rounded-b-2xl overflow-hidden">
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <a href="{{ route('home') }}" 
                   @click="open = false" 
                   class="block py-2 text-gray-600 hover:bg-gray-50 hover:text-[rgb(213,104,62)] font-poppins transition-colors duration-200 text-sm sm:text-base 
                ...
                <div>
                    ...
                    <div x-show="mobileServicesOpen" x-cloak class="bg-gray-50 pl-4 border-l-2 border-[rgb(213,104,62)]">
                        <a href="{{ route('bore-pile-hydraulic')}}" @click="open = false" class="block py-1.5 px-4 text-gray-600 hover:text-[rgb(213,104,62)] transition-colors duration-200 text-sm sm:text-base">Bore Pile Hydraulic</a>
                        <a href="{{ route('bore-pile-manual') }}" @click="open = false" class="block py-1.5 px-4 text-gray-600 hover:text-[rgb(213,104,62)] transition-colors duration-200 text-sm sm:text-base">Bore Pile Manual</a>
                        <a href="{{ route('bore-pile-mini-crane') }}" @click="open = false" class="block py-1.5 px-4 text-gray-600 hover:text-[rgb(213,104,62)] transition-colors duration-200 text-sm sm:text-base">Bore Pile Mini Crane</a>
                        <a href="{{ route('products.index') }}" @click="open = false" class="block py-1.5 px-4 text-gray-600 hover:text-[rgb(213,104,62)] transition-colors duration-200 text-sm sm:text-base">Area Layanan</a>
                    </div>
                </div>
                ...
                <a href="{{ route('about') }}" 
                   @click="open = false" 
                   class="block py-2 px-4 text-gray-600 hover:bg-gray-50 hover:text-[rgb(213,104,62)] font-poppins transition-colors duration-200 text-sm sm:text-base 
